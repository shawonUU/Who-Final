        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h2 class="card-title float-left pt-2"> {{__('My Profile')}}</h2>
                    ...
                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <table class="table table-striped table-bordered">
                                                ...
                                                <tr>
                                                    <th>{{__('Joined at')}}</th>
                                                    <td>
                                                        {{date('d M, Y', strtotime($admin_info->created_at))}}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th>{{__('Status')}}</th>
                        ...
                        <div class="col-md-7">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form action="{{route('admin.update',$admin_info->id)}}" enctype="multipart/form-data" method="POST">
                                        @method('POST')
                                        @csrf
                                        <div class="row">
                                            <div class=" form-group col-md-12 col-sm-12 col-12">
                                                <label> {{__('Name')}}</label>
                                                <input value="{{$admin_info->name}}"  type="text" name="name" class="form-control">
                                                <input value="{{$admin_info->id}}" type="hidden" name="id">
                                                <input value="{{$admin_info->type}}" type="hidden" name="type">
                                            </div>
                                            <div class=" form-group col-md-12 col-sm-12 col-12">
                                                <label> {{__('Email')}}</label>
                                                <input value="{{$admin_info->email}}"  type="email" name="email" class="form-control">
                                            </div>
                                            <div class=" form-group col-md-12 col-sm-12 col-12">
                                                <label> {{__('Phone')}}</label>
                                                <input value="{{$admin_info->phone}}"  type="number" name="phone" class="form-control">
                                            </div>
