<div class="modal fade" id="courseCreateModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        ...
        <form id="course_edit_modal_form" class="course_edit_modal_form" action="{{route('admin.course.store')}}" method="post" enctype="multipart/form-data">@csrf
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group mb-3">
                        ...
                        <input class="form-control" type="text" name="course_title"  placeholder="{{__('Course Title')}}">
                    </div>
                    <div class="form-group mb-3">
                        <label>Course Description</label>
                        <textarea class="form-control" id="" name="course_description" ></textarea>
                    </div>
                    {{-- <div class="form-group mb-3">
                        <label>Course Duration</label>
                        <input class="form-control" type="text" name="course_duration"  placeholder="{{__('Course Title')}}">
                    </div> --}}
                    <div class="form-group mb-3">
                        <label>Course Outcome</label>
                        <textarea class="form-control summernote" id="" name="course_outcome" ></textarea>
                    </div>
                    <div class="form-group mb-3">
